...
mv %{buildroot}/%{_bindir}/metalsmith{,-%{python3_version}}
ln -s %{buildroot}/%{_bindir}/metalsmith{-%{python3_version},-3}
%endif # with_python3

%py2_install
# Follow Python guidelines around Python CLI versioning
mv %{buildroot}/%{_bindir}/metalsmith{,-2.7}
ln -s %{buildroot}/%{_bindir}/metalsmith{-2.7,-2}
# This is the final binary that actual humans will be using
ln -s %{buildroot}/%{_bindir}/metalsmith{-2,}
